    ...
    <form id="form" action="./save_edit.php" method="post" class="form-horizontal text-center" style="width:500px;margin: 20px auto 0;">
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="text"  class="form-control text-center" name="id" value="<?php echo $au[0] ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon">姓名：</div>
                <input type="text" class="form-control text-center" name="name" value="<?php echo $au[1] ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon">学历：</div>
                <input type="text" class="form-control text-center" name="edu" value="<?php echo $au[2] ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon">职称：</div>
                <input type="" class="form-control text-center" name="job" value="<?php echo $au[3] ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon">单位：</div>
                <input type="text" class="form-control text-center" name="unit" value="<?php echo $au[4] ?>">
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="text" class="form-control text-center" name="phone" value="<?php echo $au[5] ?>">
            </div>
        </div>
		...
		<div class="form-group">
            <div class="input-group">
                ...
                <input type="text" class="form-control text-center" name="email" value="<?php echo $au[6] ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-addon">研究方向：</div>
                <input type="text" class="form-control text-center" name="research" value="<?php echo $au[7] ?>">
            </div>
        </div>
